		...
		this.btnInsert.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent a) {
				try {
					...
					Statement stmt=conn.createStatement();
					//insert
					stmt.executeUpdate("insert into studentlist values('"+txtId.getText()+"','"+txtName.getText()+"','"+txtDept.getText()+"','"+txtAddr.getText()+"')");
					stmt.close();
					conn.close();
					list();
					resetTextField();
		...
		this.btnUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent a) {
				try {
					...
					Statement stmt=conn.createStatement();
					// update
					stmt.executeUpdate("update studentlist set name='"+txtName.getText()+"',dept='"+txtDept.getText()+"',addr='"+txtAddr.getText()+"' where id='"+txtId.getText()+"'");
					stmt.close();
					conn.close();
					list();
					resetTextField();
			...
			public void actionPerformed(ActionEvent a) {
				...
				if(result==JOptionPane.YES_OPTION) {
					try {
						...
						Statement stmt=conn.createStatement();						
						//delete
						stmt.executeUpdate("delete from studentlist where id='"+txtId.getText()+"'");
						stmt.close();
						conn.close();
						list();
						resetTextField();
